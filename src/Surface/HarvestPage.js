    ...
    return (
        ...
        <Card
          ...
          <Form
            ...
            <Form.Item label="劑型："><Input /></Form.Item>
            <Form.Item label="商品名(廠牌):"><Input /></Form.Item>
            ...
            <Form.Item label="包裝單位:" name="Seed Sourc">          
              <Radio.Group onChange={handleSalesTargetChange} value={salesTarget}>
                <Space direction="vertical">
                  ...
                  <Radio value={4}>其他              
                      <Input placeholder="其他請填寫其他包裝單位:" style={{ width: 200, marginLeft: 10 }} />
                  </Radio>
                </Space>
              </Radio.Group>
            </Form.Item>
            ...
            <Form.Item label="包裝容量:" name="Seedling Purchase Type">
              ...
              </Select><Input placeholder="其他請填寫其他包裝容量:"style={{ width: 200, marginLeft: 10 }} />
            </Form.Item>
